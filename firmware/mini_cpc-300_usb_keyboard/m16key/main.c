 ...
 *
 * XT1..XT2: 12MHz X-tal
 * PB0..PB7: Keyboard matrix Row0..Row7
 * PD5..PD7: Keyboard matrix Row8..Row10
 * PC0..PC7: Keyboard matrix Col0..Col7
...
volatile static uchar bitbuf[NUMROWS]={0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
